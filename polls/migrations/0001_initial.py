# Generated by Django 3.2.6 on 2021-11-16 15:16
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('idIngrediente', models.CharField(choices=[('2', '2')], max_length=100, verbose_name='Id del ingrendiente')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('idReceta', models.CharField(choices=[('3', '3')], max_length=100, verbose_name='Id de la receta')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('idUsuario', models.CharField(choices=[('2', '2')], max_length=100, verbose_name='Id del Usuario')),
